  ...
  return (
    <footer className="footer px-10 py-4 text-primary-content">
      <div className="items-center grid-flow-col">
        ...
        <p>yy ©2021 Created by inyaa <br/><a href="https://beian.miit.gov.cn" target="_blank">abn-sadsa</a></p>
      </div>
      <div className="md:place-self-center md:justify-self-end">
        <div className="grid grid-flow-col gap-4">
          <a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral">本网站由 <img
            src="https://media.inyaw.com/icon/%E5%8F%88%E6%8B%8D%E4%BA%91_logo6.png" className="inline h-6"
            alt="又拍" /> 提供CDN加速/云存储服务</a>
          <a>
